    ...
    <div className="profile-modal">
      <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
        <main className="pa4 black-80 w-80">
          ...
          <input className="pa2 ba w-100" type="text" name="user-name" id="user-name" placeholder="Username" />
          <label className="mt2 fw6" htmlFor="user-age">
            Age:
          </label>
          <input className="pa2 ba w-100" type="text" name="user-age" id="user-age" placeholder="Age" />
          <label className="mt2 fw6" htmlFor="user-pet">
            Pet:
          </label>
          <input className="pa2 ba w-100" type="text" name="user-pet" id="user-pet" placeholder="Pet" />
